  ...
  return knex('locations').del()
    .then(function () {
      ...
      return knex('locations').insert([
        {id: 1,  name: 'North', parent_id: '104', island_name: 'North', region_name: '', area_name: '', crag_name: '', tc_id: '', parent_id: '', type: 'island', lat_long: '', depth: '2'},
        {id: 2,  name: 'South', parent_id: '104', island_name: 'South', region_name: '', area_name: '', crag_name: '', tc_id: '', parent_id: '', type: 'island', lat_long: '', depth: '2'},
